...
<body>
    <div data-role = "page" id = "page1" data-add-back-btn="true" data-back-btn-text="Atrás">
        ...
        <div data-role = "content">
			...
			$idVino = $_POST['idVino'];
			$valoracionVino = $_POST['valoracion'];
			$comentarioVino = $_POST['comentario'];
			...
			$cadenaSQL = "INSERT INTO comentarios(idVino, valoracion, comentario) VALUES ('$idVino', '$valoracionVino', '$comentarioVino')";
			...
			echo "<a href = 'descripcionVino.php?idVino=$idVino' data-role = 'button'>Volver al vino</a>";
