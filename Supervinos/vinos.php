...
<body>
    <div data-role = "page" id = "inicio">
        ...
        <div data-role = "content">
            <ul data-role = "listview" data-filter = "true" data-filter-placeholder = "Denominación de origen..."     >
                <?php
				...
				$cadenaSQL = "SELECT tipoVino, COUNT(*) AS total
					FROM vinos
					GROUP BY tipoVino
					ORDER BY tipoVino";
				...
				while ($fila = mysqli_fetch_object($resultado)) {
					echo "<li><a href = 'vinosPorTipo.php?tipo=$fila->tipoVino' data-transition = 'slide'>" . $fila->tipoVino . "<span class = 'ui-li-count'>". $fila->total . "</span></a></li>";
				}
